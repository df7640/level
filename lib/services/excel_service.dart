    ...
    try {
      ...
      for (int rowIndex = 1; rowIndex < sheet.rows.length; rowIndex++) {
        ...
        final station = StationData(
          ...
          foundationLevel: _getDoubleValue(row, headers['기초바닥레벨']) ?? _getDoubleValue(row, headers['기초터파기']),
          ...
          excavationDepth: _getDoubleValue(row, headers['터파기깊이']),
